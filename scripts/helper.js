export class EntitySheetHelper {
    ...
    static onAttributeRoll(event) {
        ...
        const shorthand = game.settings.get("saga-machine", "macroShorthand");
    ...
    //   const templates = collection.filter(a => a.getFlag("saga-machine", "isTemplate"));
    ...
    //         delete createData.flags.sagaMachine.isTemplate;
    //       }
    //
