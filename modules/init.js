...
export function init_saga_machine({level = 100, luck_label = 'Luck', money_label = 'Money', 
    origin_label = 'Origin', path_label = 'Path', luck_exp = false, stress = false, theme = 'unified'} = {}) {
    ...
    Hooks.once("init", async () => {
        ...
        register_config('level', level_config, level);
        register_config('luck_label', luck_label_config, luck_label);
        register_config('money_label', money_label_config, money_label);
        register_config('origin_label', origin_label_config, origin_label);
        register_config('path_label', path_label_config, path_label);
        register_config('luck_exp', luck_exp_config, luck_exp);
        register_config('stress', stress_config, stress);
        register_config('theme', theme_config, theme);
