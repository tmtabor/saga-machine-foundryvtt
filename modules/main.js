...
import { level_config, luck_exp_config, luck_label_config, money_label_config, origin_label_config, path_label_config, stress_config, theme_config } from "./system/config.js";
...
Hooks.once("init", async () => {
    ...
    game.settings.register('saga-machine', 'origin_label', origin_label_config);
    game.settings.register('saga-machine', 'path_label', path_label_config);
